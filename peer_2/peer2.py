...
class Peer2:
    ...
    def index(self):
        ...
        try:
            ...
            path = os.path.abspath("peer_2//config.json")
        ...
        response = requests.post(url, json={'peer2': {'files':files}})
        return response.json()

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Command line client for peer2 API operations')
