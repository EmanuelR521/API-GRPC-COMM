...
class Peer4:
    ...
    def index(self):
        ...
        response = requests.post(url, json={'peer4': {'files':files}})
        return response.json()

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Command line client for Peer4 API operations')
